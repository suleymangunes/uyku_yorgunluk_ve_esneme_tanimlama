...
graftop = 50  # grafigin kapsayacagi alanin ust noktasi
grafbot = 20  # grafigin kapsayacagi alanin alt noktasi
plotY = LivePlot(grafg, grafy, [grafbot, graftop], invert=True)
# orani daha dogru belirlemek icin uzaklik ortalamasi degerlerini tutacak liste tanimlandi
ratioList = []
# sinir degeri belirlendi
ustsinir = yorgunluk_sinir.sinirbul("acik goz")
altsinir = yorgunluk_sinir.sinirbul("kapali goz")
sinir = ((ustsinir - altsinir) * 0.2 ) + altsinir
...
while True:
    ...
    try:
        ...
        if faces:
            ...
            if ratioAvg < sinir:
                cvzone.putTextRect(img, 'yorgun', (50, 100), colorR=(0, 255, 0))
            ...
            imgPlot = plotY.update(ratioAvg, (255, 0, 0))
