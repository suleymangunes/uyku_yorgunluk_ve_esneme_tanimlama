...
ustsinir = uyku_sinir.sinirbul("acik goz")
altsinir = uyku_sinir.sinirbul("kapali goz")
sinir = ((ustsinir - altsinir) * 0.5 ) + altsinir
...
while True:
    ...
    try:
        ...
        if faces:
            ...
            if ratioAvg < sinir:
                cvzone.putTextRect(img, 'uyuyor', (50, 100), colorR=(0, 255, 0))
